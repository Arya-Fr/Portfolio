...
<head>
  ...
  <title>Marius Bianchi Portfolio</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/blahaj_logo.png" rel="icon">
  <link href="assets/img/blahaj_logo.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h1><a href="index.php">Marius Bianchi</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
      <h2>Je suis un passioné de <span>cybersécurité</span></h2>
      ...
      <div class="social-links">
        <a href="https://www.linkedin.com/in/marius-bianchi-31205820b/" class="linkedin" target="_blank" rel="noopener noreferrer"><i class="bi bi-linkedin"></i></a>
      </div>
